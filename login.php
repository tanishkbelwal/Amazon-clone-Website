...
if (isset($_POST['login'])) {
    ...
    // Check if the email and pass match in the database
    $query = "SELECT * FROM tanishk WHERE email = '$email' AND pass = '$pass'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<br><span style="color: red;">Invalid email or pass</span>';
    }
}
?>
